...
problem_list = ['trapezoidal', 'vector', 'matrix_multiplication',
                ...
                'monte_carlo', 'prefix_sum', 'reduction', 'filter', 'divide_and_conquer', 'travelling_salesman_problem']
...
approaches = {'trapezoidal': ['reduction', 'critical', 'private'],
              ...
              'reduction': ['tree', 'data_segmenting',
                            'segment_tree'], 'travelling_salesman_problem': ['naive', 'dp'],
...
problem_size = {'trapezoidal': [10**x for x in range(1, 9)],
                ...
                'filter': [10**x for x in range(1, 9)], 'travelling_salesman_problem': [x for x in range(9, 14)]}

processor_range = range(1, 8 + 1)
